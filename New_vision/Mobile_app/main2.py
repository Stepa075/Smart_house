...
class MenuScreen(Screen):
    def __init__(self, **kw):
        ...
        self.button2 = Button(text='World')
        self.button3 = Button(text='text')
        self.button4 = Button(text='World')
        self.button5 = Button(text='text')
        self.button6 = Button(text='World')
        self.button7 = Button(text='text')
        self.button8 = Button(text='World')
...
class app1(App):
    ...
    def pr(self):
            ...
            Variables.pomp_state=self.root.seconds_string
...
if __name__ == '__main__':
    # th1=Thread(target=logics.pumping, daemon=True)
    # th1.start()
